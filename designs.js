function makeGrid() { // a grid should appear when the user inputs numbers and clicks submit
    ...
    for (var rowCount = 0; rowCount < gridHeight; rowCount++) { // adds to row count to meet user request
    ...
    for (var numCell = 0; numCell < gridWidth; numCell++) { // adds to cell count to meet user request
